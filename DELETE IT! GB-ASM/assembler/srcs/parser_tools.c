...
{
    //читаем строки из сплита. Проходится посимвольно в ещё одном цикле.
    //Проверяет - если это символы комментария либо конец строки, то выходит из цикла и берёт следующую строку.
    //Если это пробел либо табуляция, то идёт дальше. А если это ни то, ни другое, то возвращает единицу.
