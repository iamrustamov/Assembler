...
//FIXME Daler, Bekha, игрок mat.s имеет несколько ошибок. Совместно разобрать. Когда его ошибки исправляешь, то наш говорит, что размер файла превышает размер игрока, а оригиналы продолжают работать.
//FIXME Bekha, когда несколько пустых строк, то выводит ошибку. Оригинал работает.
