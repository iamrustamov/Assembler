...
/*
 * Пока не встретил двоеточия - пропускай всё.
 * В tmp_s записывается имя операции.
 *
 */
...
/*
 * Взятую линию исследуем на метки.
 * Пропускаем комментарии;
 * Пропускаем табуляции и пробелы.
 * Если есть метка, то парсим метку.
 * Пропускаем пробелы и табуляции.
 * Если мы достигли символа конца строки, то берём следующую строку.
 * А если ещё не достигли конца строки, то выходим для продолжения парсинга.
 */
